...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup() {
        ...
        // Form fields
        l3 = createLabel("Name:", 100, 140);
        t1 = createTextField(300, 140);

        l4 = createLabel("Father's Name:", 100, 190);
        t2 = createTextField(300, 190);

        l5 = createLabel("Date of Birth:", 100, 240);
        dateChooser = new JDateChooser();
        dateChooser.setForeground(new Color(105, 105, 105));
        dateChooser.setBounds(300, 240, 400, 30);
        add(dateChooser);

        l6 = createLabel("Gender:", 100, 290);
        r1 = createRadioButton("Male", 300, 290);
        r2 = createRadioButton("Female", 450, 290);
        ButtonGroup groupGender = new ButtonGroup();
        groupGender.add(r1);
        groupGender.add(r2);

        l7 = createLabel("Email Address:", 100, 340);
        t3 = createTextField(300, 340);

        l8 = createLabel("Marital Status:", 100, 380);
        r3 = createRadioButton("Married", 300, 380);
        r4 = createRadioButton("Unmarried", 450, 380);
        r5 = createRadioButton("Other", 635, 380);
        ButtonGroup groupStatus = new ButtonGroup();
        groupStatus.add(r3);
        groupStatus.add(r4);
        groupStatus.add(r5);

        l9 = createLabel("Address:", 100, 420);
        t4 = createTextField(300, 420);

        l10 = createLabel("City:", 100, 470);
        t5 = createTextField(300, 470);

        l11 = createLabel("Pin Code:", 100, 520);
        t6 = createTextField(300, 520);

        l12 = createLabel("State:", 100, 570);
        t7 = createTextField(300, 570);

        b = new JButton("Next");
        b.setFont(mainFont);
        b.setBackground(buttonColor);
        b.setForeground(textColor);
        b.setBounds(610, 605, 90, 30);
